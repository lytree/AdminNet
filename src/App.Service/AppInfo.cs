...
public static class AppInfo
{
    ...
    /// 日志
    /// </summary>
    public static ILoggerFactory LoggerFactory => ServiceProvider?.GetService<ILoggerFactory>() ?? NullLoggerFactory.Instance;
    ...
    private static IEnumerable<Type> GetTypes(Assembly ass)
    {
        ...
        {
            LoggerFactory.CreateLogger(nameof(AppInfo)).LogError(e, "GetTypes Exception:{msg}", e.Message);
    ...
    private static IList<Assembly> GetAllAssemblies()
    {
        ...
        foreach (var lib in libs)
        {
            ...
            {
                LoggerFactory.CreateLogger(nameof(AppInfo)).LogError(e, "GetAllAssemblies Exception:{msg}", e.Message);
            }
        }
        return list;
    }
