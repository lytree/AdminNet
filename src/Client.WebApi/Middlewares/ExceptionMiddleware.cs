...
public class ExceptionMiddleware
{
    ...
    private static Task HandleAppExceptionAsync(HttpContext context, AppException appException)
    {
        ...
        return context.Response.WriteAsync(Helper.JsonSerialize(new ResultOutput<string>()
        {
    ...
    private Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        return context.Response.WriteAsync(Helper.JsonSerialize(new ResultOutput<string>().NotOk(exception.Message)));
    }
}